# Generated by Django 5.0.4 on 2024-05-14 16:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='BasePictureThemes',
            fields=[
                ('theme_id', models.IntegerField(primary_key=True, serialize=False)),
                ('theme_name', models.CharField(blank=True, max_length=20, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='UserAccuracy',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, primary_key=True, serialize=False, to='user_level.user')),
